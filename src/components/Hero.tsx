...
export default function Hero() {
  ...
  return (
    <section ref={sectionRef} id="hero" className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      {/* BG Video */}
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl">
        ...
        <p className="blur-in text-sm md:text-base text-muted max-w-md mx-auto mb-12">
          Engineering scalable backend systems & AI pipelines that power millions of users across telecom, finance, and emerging tech.
        </p>
